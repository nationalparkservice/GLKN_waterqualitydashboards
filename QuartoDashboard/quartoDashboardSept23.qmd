...
# //|output: false
# //|include: false
# viewof password = Inputs.text({label: ".   Password:", placeholder: "check email for instructions"})
# ```
```
::::: {.grid}
:::: {.g-col-3}
...
```{r}
# viewof site = {
# const  sacnParks = conditionalShow(await sacnIn, {
#   label: htl.html`<h4 style="display:inline">Saint Croix National River</h4>`,
...
# })
# 
# const missParks = conditionalShow(await missIn, {
#   label: htl.html`<h4 style="display:inline">Mississippi National River</h4>`,
#   checked: this ? this.checked : true, // keep previous value
#   // checked: false,
#   returns: (checked, navElem) => (checked ? navElem.value : navElem.value) // what do you want it to return
# })
# 
# const isroParks = conditionalShow(await isroIn, {
#   label: htl.html`<h4 style="display:inline">Isle Royale National Park</h4>`,
#   checked: this ? this.checked : true, // keep previous value
#   // checked: false,
#   returns: (checked, navElem) => (checked ? navElem.value : navElem.value) // what do you want it to return
# })
# 
# const voyaParks = conditionalShow(await voyaIn, {
#   label: htl.html`<h4 style="display:inline">Voyageurs National Park</h4>`,
#   checked: this ? this.checked : true, // keep previous value
#   // checked: false,
#   returns: (checked, navElem) => (checked ? navElem.value : navElem.value) // what do you want it to return
# })
# 
# const slbeParks = conditionalShow(await slbeIn, {
#   label: htl.html`<h4 style="display:inline">Sleeping Bear Dunes National Lakeshore</h4>`,
#   checked: this ? this.checked : true, // keep previous value
#   // checked: false,
#   returns: (checked, navElem) => (checked ? navElem.value : navElem.value) // what do you want it to return
# })
# 
# const induParks = conditionalShow(await induIn, {
#   label: htl.html`<h4 style="display:inline">Indiana Dunes National Park</h4>`,
#   checked: this ? this.checked : true, // keep previous value
#   // checked: false,
#   returns: (checked, navElem) => (checked ? navElem.value : navElem.value) // what do you want it to return
# })
# 
# const apisParks = conditionalShow(await apisIn, {
#   label: htl.html`<h4 style="display:inline">Apostle Islands National Lakeshore</h4>`,
#   checked: this ? this.checked : true, // keep previous value
#   // checked: false,
#   returns: (checked, navElem) => (checked ? navElem.value : navElem.value) // what do you want it to return
# })
# 
# const piroParks = conditionalShow(await piroIn, {
#   label: htl.html`<h4 style="display:inline">Pictured Rocks National Lakeshore</h4>`,
#   checked: this ? this.checked : true, // keep previous value
#   // checked: false,
#   returns: (checked, navElem) => (checked ? navElem.value : navElem.value) // what do you want it to return
# })
# 
# return [sacnParks, missParks, isroParks, voyaParks, slbeParks, induParks, apisParks, piroParks];
# 
# }
# //site1 = [sacnParks, missParks, isroParks, voyaParks, slbeParks, induParks, apisParks, piroParks]
# 
# //site = site1.flat(1);
```
